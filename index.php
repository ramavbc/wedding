...
<div id="page">
	...
	<div id="floating-button" class="float">
		<div class="control-center open">
			<div class="audio-play">
				<div data-video="viW0M5R2BLo" data-autoplay="0" data-loop="1" id="youtube-audio1"></div>
			</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box fadeInUp animated-fast">
						<img src="images/fotokami.png" size="500px" alt="" class="couple-main">
					</div>
				</div>
				<div class="row">
	...
	<div id="fh5co-header">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
					<img src="images/fotokami.png" alt="" class="couple-main">
				</div>
			</div>
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
					...
					<br>
					<p>
						<!--<a href="https://calendar.google.com/calendar/u/0/r/eventedit/NmhwbmtrN3VoN3ZybDVsYThhazhjZGd2bXAgcmFtYWluY2VwdGlvbkBt" target="_blank" class="btn btn-primary btn-sm">Save the date</a><br>
			...
			<div class="couple-wrap animate-box">
				...
				<div class="couple-half">
					...
					<div class="desc-bride">
						<h3>Siti Solihat</h3>
						<p><span style="color: #bf9b73">Anak Kedua dari</span><br>
							<span class="parents-font">Alm. Bapak Jajang</span>
							<br>
							<span class="parents-font">Ibu Eem</span>
						</p>
	...
	<div id="fh5co-event" class="fh5co-bg" style="border-top: 1px solid #f2f2f2">
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
					<h2>Pada Tanggal</h2>
					<!--<a href="calendar.ics" class="btn btn-info"><i class="icon-download2"></i></a></h2>-->
				</div>
			</div>
			<div class="row">
				<div class="col-md-10 col-md-offset-1">
					<div class="col-md-6 col-sm-6 text-center">
						<div class="event-wrap animate-box">
							<h3 style="font-family: 'Oswald', Arial, serif;">Acara Utama</h3>
							<div class="event-col">
							...
							<div class="event-col">
								...
								<span>Senin</span>
								<span class="tanggal">08 Mei 2023</span>
							</div>
							<p style="font-family: 'Courgette', Arial, serif">Alamat : Villa Nadya, Jl. Padat Karya No.69, Rt 05/03, Batu Layang, Kec. Cisarua, Kabupaten Bogor, Jawa Barat</p>
					...
					<div class="col-md-6 col-sm-6 text-center">
						<div class="event-wrap animate-box">
							...
							<form action="#">
 <a target="_blank" href="https://calendar.google.com/calendar/event?action=TEMPLATE&amp;tmeid=NTNpanEwa2VoNjFwanM4bWc3YTE1Y21xZDIgcmFtYWluY2VwdGlvbkBt&amp;tmsrc=ramainception%40gmail.com"><img border="0" src="https://www.google.com/calendar/images/ext/gc_button1_en.gif"></a>
							...
							<a href="https://goo.gl/maps/ZQpsJwJVnawCZZ4R9" target="_blank"
							   class="btn btn-primary">Penunjuk Lokasi <i class="icon-map2"></i></a>-->
						</div>
					</div>
					<div class="col-md-6 col-sm-6 text-center">
					<br>
						<li onclick="scrollToElement('fh5co-testimonial')" target="blank" class="btn btn-success">Ya, Saya Dapat Hadir</li><br>
							<a href="https://calendar.google.com/calendar/event?action=TEMPLATE&amp;tmeid=NTNpanEwa2VoNjFwanM4bWc3YTE1Y21xZDIgcmFtYWluY2VwdGlvbkBt&amp;tmsrc=ramainception%40gmail.com" target="blank" class="btn btn-primary">Saya Masih Ragu (Simpan Tanggal)</a><br>
							<li onclick="scrollToElement('fh5co-gallery')" class="btn btn-danger">Maaf, saya tidak dapat hadir</li><br>
							<a target="_blank" href="https://calendar.google.com/calendar/event?action=TEMPLATE&amp;tmeid=NTNpanEwa2VoNjFwanM4bWc3YTE1Y21xZDIgcmFtYWluY2VwdGlvbkBt&amp;tmsrc=ramainception%40gmail.com"><img border="0" src="https://www.google.com/calendar/images/ext/gc_button1_en.gif"></a>
		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
					<h2>Lokasi Acara</h2>
					<span style="color: #bf9b73">Silahkan gunakan fitur Google Maps dibawah ini.</span><br>
			...
			<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d507181.9212717421!2d106.9623180501058!3d-6.7260061168665395!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69b64ee022d88b%3A0xca677b434f1c4f97!2sVilla%20Nadia!5e0!3m2!1sid!2sid!4v1678625819136!5m2!1sid!2sid" style="border:0; width: 100%; height: 500px;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
					...
					<a href="https://goo.gl/maps/CRKTppswadftyf5t8" target="_blank"
							   class="btn btn-primary">Penunjuk Lokasi <i class="icon-map2"></i></a><br>
							   <span style="color: #bf9b73">Whatsapp kami untuk kejelasan lokasi acara :</span><br>
							   <a href="https://wa.me/628986888858?text=Terimakasih%20Undangannya,%20Mohon%20dibantu%20untuk%20dapat%20sampai%20lokasi%20acara" target="_blank"
							   class="btn btn-primary">Solihat<i class="icon-chat"></i></a>
							   <a href="https://wa.me/6285156496390?text=Terimakasih%20Undangannya,%20Mohon%20dibantu%20untuk%20dapat%20sampai%20lokasi%20acara" target="_blank"
							   class="btn btn-primary">Ramadhani<i class="icon-chat"></i></a>
							   <a href="https://wa.me/6285155038055?text=Terimakasih%20Undangannya,%20Mohon%20dibantu%20untuk%20dapat%20sampai%20lokasi%20acara" target="_blank"
							   class="btn btn-primary">Bapak Sukarman<i class="icon-chat"></i></a>
				</div>
			</div>
			<!--<div class="row">
		...
		<div class="container">
			...
			<div class="row copyright animate-box">
				<div class="col-md-12 text-center">
					...
					<img src="images/fotokami.png" width="100" height="100">
					<br>
					<h1 style="font-family: 'Satisfy', Arial, serif">Rama & Solihat</h1>
					...
					<!--<ul class="fh5co-social-icons">
						...
						<li><a target="_blank" href="https://www.instagram.com/maulidannashuha/"><i class="icon-instagram"></i></a></li>
						<li><a target="_blank" href="https://www.facebook.com/maulidannashuha"><i class="icon-facebook"></i></a></li>
